  ...
  return (
    <div className="h-screen w-full leftsection flex justify-center items-center">
      <div className="flex flex-col justify-start items-start  md:w-[80%] h-[80%] my-24 md:ml-28">
        ...
        <h1 className="font-light text-[#f19a99] text-center md:text-left">We're </h1>
        <h1 className="md:w-[50%] font-semibold text-center md:text-left">coming soon</h1>
        </div>
        ...
        <div className="md:w-[30rem]  h-[3.5rem] border-solid border-2 border-gray-400  flex flex-row justify-between items-center pl-5  rounded-[2rem]">
          <input type="email" value={email} name="email" placeholder="Email Address" className="w-full border-none outline-0" onChange={Change}/>
          <img src={error} alt="" className={`mr-[0.4rem] ${err?"hidden":"visible"}`}/>
          <button className="bg-black w-[8.5rem] h-[3.55rem] p-2 flex justify-center items-center btn rounded-[2rem] hover:cursor-pointer" onClick={validateEmail}>
            <img src={arrow} alt="" />
          </button>
        </div>
